      ...
      //  GET: /Account/Login
       ...
       [AllowAnonymous]
        public ActionResult Login(string returnUrl)
        {
            ...
            //serviceResponse = utility.GetAsync(WebApiURL.AccountGet);
            //lstAccount = serviceResponse.StatusCode == HttpStatusCode.OK ? serviceResponse.Content.ReadAsAsync<List<Account>>().Result : null;
