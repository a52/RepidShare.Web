...
namespace RepidShare.Web.Controllers
{
    public class BaseController : Controller
    {
        ...
        public MasterSettingModel MasterSetting
        {
            get
            {
                MasterSettingModel objMasterSetting = new MasterSettingModel();
                if(Session["MasterSetting"] != null)
                   objMasterSetting = (MasterSettingModel)Session["MasterSetting"];

                return objMasterSetting;
            }
        }
        ...
        public void DropDownValue()
        {
            try
            {
                ...
                ViewBag.DropDownList = new MultiSelectList(objDropdown, "Id", "Value");
            }
            catch (Exception ex)
            {
                ErrorLog(ex, "Step", "FillStepDropDown");
